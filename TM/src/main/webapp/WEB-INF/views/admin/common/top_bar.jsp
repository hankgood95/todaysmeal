		...
		<ul class="navbar-nav ml-auto">
					...
					<a class="dropdown-item d-flex align-items-center" href="#">
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="${pageContext.servletContext.contextPath}/resources/admin/img/undraw_profile_1.svg"
								alt="...">
						...
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="${pageContext.servletContext.contextPath}/resources/admin/img/undraw_profile_2.svg"
								alt="...">
						...
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="${pageContext.servletContext.contextPath}/resources/admin/img/undraw_profile_3.svg"
								alt="...">
			...
			<li class="nav-item dropdown no-arrow"><a
				...
				aria-expanded="false"> <span
					...
					src="${pageContext.servletContext.contextPath}/resources/admin/img/undraw_profile.svg">
